...
public class GameManager : MonoBehaviour
{
    ...
    Vector3[] positions = {
                            ...
                            new Vector3(655.47f, 0.02f, 518.65f),
                            new Vector3(578.0368f, 0.02f, 498.1187f),
                            new Vector3(575.0418f, 0.02f, 441.9167f),
                            new Vector3(562.62f, 0.02f, 413.5057f),
                            new Vector3(710.0f, 0.02f, 522.0f)
                          };
    ...
    public void SpawnEnemy(GameObject enemyObject){
      ...
      Instantiate(enemy, positions[Random.Range(0,10)], Quaternion.identity);
    } 
